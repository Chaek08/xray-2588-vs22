...
void CEntityCondition::SConditionChangeV::load(LPCSTR sect, LPCSTR prefix)
{
	...
	m_fV_Radiation			= pSettings->r_float(sect,xr_strconcat(str,"radiation_v",prefix));	
	m_fV_RadiationHealth	= pSettings->r_float(sect,xr_strconcat(str,"radiation_health_v",prefix));
	m_fV_EntityMorale		= pSettings->r_float(sect,xr_strconcat(str,"morale_v",prefix));
	m_fV_PsyHealth			= pSettings->r_float(sect,xr_strconcat(str,"psy_health_v",prefix));	
	m_fV_Bleeding			= pSettings->r_float(sect,xr_strconcat(str,"bleeding_v",prefix));
	m_fV_WoundIncarnation	= pSettings->r_float(sect,xr_strconcat(str,"wound_incarnation_v",prefix));
